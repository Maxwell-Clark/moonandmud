...
export default async function Home() {
  ...
  return (
    <>
      ...
      <section className="-mt-px pt-8 md:pt-12 pb-16 md:pb-24 bg-brown text-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="font-display text-5xl md:text-6xl lg:text-7xl font-bold text-gold mb-4">
              Featured Pieces
            </h2>
            <p className="font-display text-base md:text-lg font-semibold text-cream/70 max-w-2xl mx-auto">
