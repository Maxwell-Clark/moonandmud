        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              ...
              <span suppressHydrationWarning dangerouslySetInnerHTML={{ __html: '' }} className="snipcart-items-count absolute -top-1 -right-1 bg-gold text-white text-xs w-5 h-5 rounded-full flex items-center justify-center" />
            </button>
